...
The first step in the analysis is to compare the signup rates between the two versions of the homepage to visualise the overall density and distribution of the results.

```{r plot1, fig.width=9, fig.height=5}
